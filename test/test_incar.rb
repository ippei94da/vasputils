...
class TC_Incar < Test::Unit::TestCase
  ...
  def test_append
    setting = VaspUtils::Setting.new("test/incar/dot.vasputils")

    incar = VaspUtils::Incar.new
    incar.clear
    assert_equal({}, incar)

    incar.append("base", setting)
    correct = {
      'SYSTEM' =>  "Generated by VaspUtils::Incar",
      'PREC' =>    "High",
      'NELM' =>    60,
      'NELMIN' =>  2,
      'EDIFF' =>   1.0e-05,
    ...
    assert_equal(correct, incar)

    incar.append("singlepoint", setting)
    correct = {
      'SYSTEM' =>  "Generated by VaspUtils::Incar",
      'PREC' =>    "High",
      'NELM' =>    60,
    ...
    incar = VaspUtils::Incar.new
    incar.clear
    incar.append("spin1", setting)
    assert_equal({"ISPIN" => 1}, incar)

    incar.append("spin2", setting)
