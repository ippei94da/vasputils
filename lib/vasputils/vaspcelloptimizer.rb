...
class VaspUtils::VaspCellOptimizer < Comana::ComputationManager
    ...
    def self.show_inspect(args)
        ...
        #    begin
        #        calc = VaspUtils::VaspCellOptimizer.new(dir)
        ...
        #    rescue VaspUtils::VaspCellOptimizer::InitializeError
        #        klass_name = "-------"
        #        state = toten = ld_str = "---"
        #    end
    ...
    def self.show_latest(args)
        ...
        #    klass_name = "VaspGeomOpt"
        #    begin
        #        calc = VaspUtils::VaspCellOptimizer.new(target)
        #    rescue
        #        next
        #    end
    ...
    def self.run(args)
        ...
        targets.each do |dir|
            begin
                calc_dir = VaspUtils::VaspCellOptimizer.new(dir)
                calc_dir.start
            rescue VaspUtils::VaspCellOptimizer::NoVaspDirError
                puts "Not suitable for VaspCellOptimizer: #{dir}"
                exit
    ...
    def self.next(args)
        ...
        targets.each do |tgt_dir|
            ...
            begin
                tgt = VaspUtils::VaspCellOptimizer.new(tgt_dir)
            rescue VaspUtils::VaspCellOptimizer::NoVaspDirError
                puts "  Not VaspCellOptimizer: #{tgt_dir}"
                next
            end
            ...
            begin
                tgt.reset_next
            rescue VaspUtils::VaspCellOptimizer::NoContcarError
    ...
    def calculate
        ...
        #    else
        #        #dir = prepare_next
        #        puts "Cell optimization fihished. Exit."
        #    end
        #end
        #puts "Cell optimization fihished. Exit."
